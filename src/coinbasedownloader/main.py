...
from coinbasedownloader.service import sync_all_active_updates
...
async def main():
    ...
    # from_dt: datetime = datetime.fromisoformat("2020-01-01 00:00:00+00:00")
    # to_dt: datetime = datetime.now(timezone.utc)
    # await fetch_all_active_from_to(from_dt, to_dt, CandlePeriod.ONE_HOUR)

    await sync_all_active_updates(CandlePeriod.ONE_HOUR)
